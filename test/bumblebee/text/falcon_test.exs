  ...
  describe "integration" do
    test "base model" do
      assert {:ok, %{model: model, params: params, spec: spec}} =
               # TODO - fix model test location/create
               Bumblebee.load_model({:hf, "seanmor5/tiny-falcon-test"}, architecture: :base)
    ...
    test "sequence classification model" do
      assert {:ok, %{model: model, params: params, spec: spec}} =
               Bumblebee.load_model(
                # TODO - fix model test location/create
                 {:hf, "HuggingFaceH4/tiny-random-falconForSequenceClassification"}
               )
    ...
    test "causal language model" do
      assert {:ok, %{model: model, params: params, spec: spec}} =
               # TODO - fix model test location/create
               Bumblebee.load_model({:hf, "seanmor5/tiny-falcon-test"},
